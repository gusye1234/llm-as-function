...
llama3_1_func = LLMFunc(temperature=0.1, model="llama3.1", has_tool_support=True)
llama3_3_func = LLMFunc(temperature=0.1, model="llama3.3", has_tool_support=True)
llama3_2_1b_func = LLMFunc(temperature=0.1, model="llama3.2.1b", has_tool_support=True)
qwq_func = LLMFunc(temperature=0.1, model="krtkygpta/qwq", has_tool_support=True)
qwen2_1_5b_func = LLMFunc(temperature=0.1, model="qwen2:1.5b", has_tool_support=True)  # This has tool support but i haven't be able to relabily use it
